...
$usuarios = "SELECT * FROM paciente, solicitud_medica, usuario WHERE (idusuario1 = Id and Id = idusuario3) AND estado = 'rechazada'";
?>
...
<body>
    <div class="container-table">
        ...
        <div class="table__header">Aceptar/rechazar</div>
...
while ($row = $resultado->fetch_array())  { 
    ?> 
       ...
       <a href="solicitudaceptada.php?id=<?php echo $row["idsolicitud_medica"];?>" class="table__item__link">Aceptar</a>   /
       <a href="rechazarsolicitud.php?id=<?php echo $row["idsolicitud_medica"];?>" class="table__item__link">rechazar</a></div>   
