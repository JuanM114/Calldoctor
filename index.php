...
<head>
    ...
    <link rel="stylesheet" href="css/continuarresgistro.css">
...
<nav class="navbar">
   ...
   <h1 class="animate__animated animate__backInLeft">Inicio de sesion como paciente</h1>
