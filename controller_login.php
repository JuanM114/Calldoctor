<?php 
	...
	if (isset($_POST['registrarse'])) {
		...
		$usuario=$crud->obtenerUsuario($_POST['usuario'],$_POST['pas'],$_POST['tipo'] );
		...
		if ($usuario->getId()!=NULL) {
			...
			header('Location: continuarregistro.php'); //envia a la página que simula la cuenta
		}else{
		...
		header('Location: index.php');
		session_destroy($_SESSION['usuario']); //destruye la sesión
	}
?>